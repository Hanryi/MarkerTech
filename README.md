...
The input parameters of PrimerDesigner.py are: strategy code name (iBP-seq: 3), input template file, file name (including .xlsx suffix), shortest primer length, optimal primer length, longest primer length, shortest amplicon length, optimal amplicon length, longest amplicon length, minimum *T*~m~ of primer, optimal *T*~m~ of primer, maximum *T*~m~ of primer. 
